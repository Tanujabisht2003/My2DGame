...
public class Lighting {
	...
	public void setLightSource() {
		...
		if(gp.player.currentLight == null) {
			...
			int centerY = gp.player.screenX + (gp.tileSize)/2;
	...
	public void update() {
		...
		if(dayState == day) {
			...
			// agar hame time badna hai day der tak rahe 600 =10 second 36000 for 10 min
			if(dayCounter > 600) {
				dayState = dusk;
				dayCounter = 0;
			}
		...
		if(dayState == dusk) {
			// for transaction speed we use smaller no
			filterAlpha += 0.001f;
