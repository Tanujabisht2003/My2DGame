...
//		gp.player.Life = 3;
	...
	public void drawTitleScreen() {
		...
		if(titleScreenState == 0) {
			...
			//BLUE BOY IMAGE
			x = gp.screenWidth/2 - (gp.tileSize*2)/2;// centre point 
			y += gp.tileSize*2;
			g2.drawImage(gp.player.down1, x, y, gp.tileSize*2, gp.tileSize*2, null);// fourth one is the size of image
...
//		}
	...
	public void drawDialougeScreen() {
		...
		g2.setFont(g2.getFont().deriveFont(Font.PLAIN, 32F));//pursia, arial
		x += gp.tileSize;
		y += gp.tileSize;
	...
	public void trade_sell() {
		...
		if(gp.keyH.enterPressed == true) {
			...
			if(gp.player.inventory.get(itemIndex) == gp.player.currentWeapon || gp.player.inventory.get(itemIndex) == gp.player.currentShield) {
				...
				subState = 0;
				gp.gameState = gp.dialogueState;
				currentDialogue = "You cannot sell an equped item!";
			}
			else {
