...
public class MON_Orc extends Entity{
	...
	public void getImage() {
		...
		left1 = setup("/monster/orc_right_1",gp.tileSize,gp.tileSize);
		left2 = setup("/monster/orc_right_2",gp.tileSize,gp.tileSize);
		right1 = setup("/monster/orc_left_1",gp.tileSize,gp.tileSize);
		right2 = setup("/monster/orc_left_2",gp.tileSize,gp.tileSize);
	}
