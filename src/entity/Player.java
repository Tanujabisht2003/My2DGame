...
//		gp.currentMap = 1;
		...
		// PLAYER STATUS
		level = 1;
		maxLife = 6;// 1 MEANS HALF HEART 2 MEANS FULL HEART 6 MEANS 3 FULL HEART
		life = maxLife;
		maxMana = 4;
		mana = maxMana;
		ammo =10;
	...
	public  void update() {
		...
		if(attacking == true) {
			attacking();
			 ...
			 //CHECK TILE INTERACTIVE COLLISION 
		 ...
		 if(gp.keyH.shortKeyPressed == true && projectile.alive == false && shotAvailableCounter == 30 && projectile.haveResource(this) == true) {
